                ...
                <div class="card-body">
                    <form action="{{ route('service.update', $service->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $service->title }}" class="form-control @error('title') is-invalid @enderror" id="exampleFormControlInput1" placeholder="Enter service title" name="title">
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" placeholder="Enter description" class="form-control @error('description') is-invalid @enderror" id="exampleFormControlInput1" cols="30" rows="10">{{ $service->description }}</textarea>
                            @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" {{ $service->icon }} class="form-control @error('icon') is-invalid @enderror" id="showThat" name="icon" placeholder="Select Service Icon" data-toggle="modal" data-target="#iconModal">
                            @error('icon')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
